...
## 9) Data integrity (mandatory for all AI/code agents)

- Do **not** modify database schemas, persistence files, or bulk-rewrite dataset/page/post rows unless the maintainer explicitly requests it.
- Do **not** delete or “normalize away” CMS/API data to fix UI issues.
