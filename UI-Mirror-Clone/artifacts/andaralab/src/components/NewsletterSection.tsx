...
export default function NewsletterSection() {
  ...
  const tags =
    locale === "id"
      ? ["Intisari Riset Mingguan", "Rilis Data", "Siaran Kebijakan"]
      : ["Weekly Research Digest", "Data Releases", "Policy Alerts"];

  const topics =
    locale === "id"
      ? ["Makro", "Kebijakan Moneter", "Sektoral", "ESG", "Pasar"]
      : ["Macro", "Monetary Policy", "Sectoral", "ESG", "Markets"];
