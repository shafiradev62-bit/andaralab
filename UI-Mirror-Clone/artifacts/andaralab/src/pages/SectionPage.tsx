...
function SectionPageLayout({
  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      <section className="border-b border-[#E5E7EB] dark:border-white/10 py-12">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex items-center gap-2 text-[12px] text-gray-400 dark:text-gray-500 mb-4">
          ...
          <h1 className="text-[34px] font-bold text-gray-900 dark:text-gray-50 mb-3">{section}</h1>
          <p className="text-[14.5px] text-gray-500 dark:text-gray-400 max-w-[560px]">{description}</p>
        </div>
      </section>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-10">
        ...
        {!isLoading && posts.length === 0 && (
          <div className="text-center py-24 text-gray-400 dark:text-gray-500">
            ...
            <Link href="/admin" className="text-[13px] text-gray-900 dark:text-gray-100 hover:underline">
            ...
            {posts.map((post, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h2 className={`font-semibold text-gray-900 dark:text-gray-100 mb-2 leading-snug transition-colors ${i === 0 ? "text-[20px]" : "text-[15px]"}`}>
                    {post.title}
                  </h2>
                  {post.excerpt && (
