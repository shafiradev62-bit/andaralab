...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Hero background image — object-fit cover, anchored to top so city skyline shows */}
      <img
        src="/IMG-20260424-WA0029 (1).jpg"
        alt=""
        aria-hidden="true"
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 pt-32 pb-20 w-full" style={{ zIndex: 2 }}>
