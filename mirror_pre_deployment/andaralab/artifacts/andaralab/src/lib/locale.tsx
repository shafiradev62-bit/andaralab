...
const translations = {
  en: {
    ...
    start_api_server: "http://76.13.17.91:3001/api/health",
    showing_cached_data: "Showing cached data. Check VPS API health",
    ...
    meta_models_description: "Comparative overview of frontier large language models — context windows, pricing, and capabilities for macroeconomic and financial research use cases.",
    ...
    // About section
    about_andaralab_heading: "About AndaraLab",
    laboratory_for_economic_intelligence: "A Laboratory for Economic Intelligence",
  ...
  id: {
    ...
    start_api_server: "http://76.13.17.91:3001/api/health",
    showing_cached_data: "Menampilkan data tersimpan. Cek API VPS",
    ...
    gold: "Emas",
    featured_charts: "Grafik Unggulan",
    ...
    meta_models_description: "Perbandingan model bahasa besar (LLM) terdepan — context window, harga, dan kemampuan untuk riset makroekonomi dan keuangan.",
    ...
    // About section
    about_andaralab_heading: "Tentang AndaraLab",
    laboratory_for_economic_intelligence: "Laboratorium untuk Intelijen Ekonomi",
    our_approach_heading: "Pendekatan Kami",
  },
} as const;
...
/** Detect locale from the current URL path (/id/... or /en/...) */
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  const [locale, setLocaleState] = useState<Locale>(() => {
    // URL slug takes priority over localStorage so /id/... always starts in Indonesian
  ...
  const t = useCallback(
    (key: string): string => {
      const localeStrings = (translations as Record<string, Record<string, string>>)[locale];
